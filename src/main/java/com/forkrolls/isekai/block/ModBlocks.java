package com.forkrolls.isekai.block;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> AMONG_US_ORE = registerBlock("among_us_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.of(Material.AMETHYST)
                    .strength(12f).requiresCorrectToolForDrops(), UniformInt.of(10,20)));
    ...
    public static final RegistryObject<Block> NETHERRACK_AMONG_US_ORE = registerBlock("netherrack_among_us_ore",
            () -> new DropExperienceBlock(BlockBehaviour.Properties.of(Material.STONE)
                    .strength(20f).requiresCorrectToolForDrops(), UniformInt.of(10,20)));
